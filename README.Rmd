...
**Under development -- though functions mentioned on this page should work (they
just might change slightly before the formal release of version 1.0.0) **
...
in our two earlier papers [1, 2], which should be read to properly understand the package.
