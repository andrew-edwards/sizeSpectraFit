...
knitr::opts_chunk$set(
  ...
  comment = "",
  cache = TRUE,
  cache_path = "med-analysis-8-cache/",
  fig.path = "med-analysis-8-figs-cache/",
  fig.width = 7,
  fig.height = 9
)
  # comment = "#>",
...
rmarkdown::render("med-analysis-8.Rmd")
```
...
Here (`med-analysis-8.Rmd`) we set $x_{\text min}$ for all groups to be the full
community baseline value, as calculated in `med-analysis-4.Rmd`.
...
# For group-specific values copy code from med-analysis-7.Rmd
xmin_crust <- xmin_full

xmin_actin <- xmin_full

xmin_chondr <- xmin_full

xmin_cephsmall <- xmin_full

xmin_cephlarge <- xmin_full
