...
rmarkdown::render("med-summary-13.Rmd")
```
...
```{r plotsummary2, fig.width = 11, fig.height = 6, fig.cap = "As for previous Figure but restricting the y-axis (which misses the NTR results for Chondrichthyes).", echo = FALSE, eval = FALSE}
plot_multiple_exponents(res_table_agg,
                        ylim = c(-5, -1),
                        col_strata = strata_col,
                          shade_first = TRUE)
