...
knitr::opts_chunk$set(
  ...
  comment = "",
  cache = TRUE,
  cache_path = "med-analysis-11-cache/",
  fig.path = "med-analysis-11-figs-cache/",
  fig.width = 7,
  fig.height = 9
)
  # comment = "#>",
...
rmarkdown::render("med-analysis-11.Rmd")
```
...
Here (`med-analysis-11.Rmd`) we determine $x_{\text min}$ as being the minimum
$x_{\text min}$ determined in analysis-4 for each group. So being consistent
within groups, which will make comparisons easier.

Determining $x_{\text max}$ independently within each group.

<!-- groups (using the modal method) as for `med-analysis-4.Rmd`, and set
$x_{\text max}$ for each group to be the maximum $x_{\text max}$ determined for
that group in `med-analysis-4.Rmd` (then not excluding any data). -->
...
TODO Go the opposite direction to theory.
