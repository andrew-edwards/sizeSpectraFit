...
# a .tiff to insert into Word file, based on Nick's suggestion:
## tiff(filename = "panelplot.tiff",
##      height = 7,
##      width = 9,
##      units = 'in',
##      compression = "lzw",
...
# dev.off()    # uncomment to make .tiff manually
```
...
```{r plotsummary2, fig.width = 11, fig.height = 6, fig.cap = "As for previous Figure but restricting the y-axis (which misses the NTR results for Chondrichthyes).", echo = FALSE}
plot_multiple_exponents(res_table_agg,
                        ylim = c(-5, -1),
                        col_strata = strata_col,
                          shade_first = TRUE)
