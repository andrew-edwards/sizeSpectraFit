...
knitr::opts_chunk$set(
  ...
  comment = "",
  cache = TRUE,
  cache_path = "med-analysis-10-cache/",
  fig.path = "med-analysis-10-figs-cache/",
  fig.width = 7,
  fig.height = 9
)
  # comment = "#>",
...
rmarkdown::render("med-analysis-10.Rmd")
```
...
Here (`med-analysis-10.Rmd`) we determine $x_{\text min}$ independently for all
...
explicitly, no need for `strata_for_xmax` here:
```{r setxmax}
