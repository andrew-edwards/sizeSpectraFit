...
knitr::opts_chunk$set(
  ...
  comment = "",
  cache = TRUE,
  cache_path = "med-analysis-7-cache/",
  fig.path = "med-analysis-7-figs-cache/",
  fig.width = 7,
  fig.height = 9
)
  # comment = "#>",
...
rmarkdown::render("med-analysis-7.Rmd")
```
...
Here (`med-analysis-7.Rmd`) we set $x_{\text min}$ for each group to be the NTR value for that group, as
