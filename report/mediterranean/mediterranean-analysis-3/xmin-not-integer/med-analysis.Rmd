...
This is after setting xmin to be the min `bin_min` value above the histogram
determined minimum. Still have big fish in there.
...
TODO not done yet, want to finish first to have something to compare with
original results regarding the other changes to actin and chrond.
