...
knitr::opts_chunk$set(
  ...
  comment = "",
  cache = TRUE,
  cache_path = "med-analysis-13-cache/",
  fig.path = "med-analysis-13-figs-cache/",
  fig.width = 7,
  fig.height = 9
)
  # comment = "#>",
...
rmarkdown::render("med-analysis-13.Rmd")
```
...
Here (`med-analysis-13.Rmd`) we determine $x_{\text min}$ as being the values
Juliana obtained from looking at the data, seeing where the data start being
continuous. And using same value within each group.
