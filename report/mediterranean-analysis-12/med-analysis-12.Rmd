...
knitr::opts_chunk$set(
  ...
  comment = "",
  cache = TRUE,
  cache_path = "med-analysis-12-cache/",
  fig.path = "med-analysis-12-figs-cache/",
  fig.width = 7,
  fig.height = 9
)
  # comment = "#>",
...
rmarkdown::render("med-analysis-12.Rmd")
```
...
Here (`med-analysis-12.Rmd`) we determine $x_{\text min}$ as being the minimum
$x_{\text min}$ determined in analysis-4 for each group. So being consistent
within groups, which will make comparisons easier.

Setting $x_{\text max}$ for each group to be the maximum $x_{\text max}$ determined for
