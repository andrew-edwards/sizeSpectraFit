...
knitr::opts_chunk$set(
  ...
  comment = "",
  cache = TRUE,
  cache_path = "med-analysis-cache/",
  fig.path = "med-analysis-figs-cache/",
  fig.width = 7,
  fig.height = 9
)
  # comment = "#>",
...
rmarkdown::render("med-analysis.Rmd")
```
...
TODO edit: Copy and pasting analysis for a particular species group, then just find and
...
TODO edit: Also, the results show clear distinct ranges of data.
