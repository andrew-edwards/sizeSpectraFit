...
Here (`med-analysis-5.Rmd`) we set $x_{\text min}$ for each group to be the baseline value for that group, as
...
to change filenames for each analysis (`med-analysis-5.Rmd` etc.), files will be in the correct directory
