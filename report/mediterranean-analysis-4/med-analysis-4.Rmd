...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "",
  cache = FALSE,   # TODO will want at some point
...
once up front but a bit fiddly). Also going to rewrite `calc_max_of_bin()` to
...
HERE - carry on, can remove some of the upcoming. Results will change slightly,
so best just to plough on here I think and then compare overall results and
figures with version 3. HERE.
