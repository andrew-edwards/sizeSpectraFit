...
table(crust_fg$length)[1:10]   # crustacea FG, looks like nearest 0.1 mm
...
## Combine data - need to do this for each data set in turn given different bin widths
...
TODO rewrite function also (see vignette comment)
