...
Now do MLEbin, then come back and add extra options for this one (since will first
create binned figures for MLEbin). TODO

### Binned data of counts in bins

TODO Basically am redoing the MLEbin_recommend vignette but with more usable functions.
