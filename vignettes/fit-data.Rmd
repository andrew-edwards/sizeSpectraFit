...
The simulated data used for Figures 1 and 2 of
...
res_vec    # We have set it up to just print the MLE results plus only the first
           # 10 values of the original data, sim_vec. To see all the data just do:
# res_vec$x    # This will print all 1000 values
