...
HERE currently that plot is not correct


HERE need to set up plotting function I think. See plot.determine...mlebins, has
some explicit mlebins lines in there, prob just adapt them for mlebin TODO HERE HER
We can plot and then print the results:
```{r, mockplot, fig.height = 8}
plot(res_mock)
```
