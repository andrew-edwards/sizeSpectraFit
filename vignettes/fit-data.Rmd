...
```{r, MLE2}
NEW CODE GIVES DIFFERENT CONF - previously had conf as -2.097417 -1.964317. See .html
Set up a test to check, and obtain values from sizeSpectra code. Need to figure
out why.
