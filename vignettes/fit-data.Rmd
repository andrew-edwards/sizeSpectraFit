...
g, but this can easily be changed (described below).
...
The fourth option is only suitable for when the data represent body masses. It
...
TODO change default x-axis label to body mass, x, g and mention that above.

HERE carry on checking through these (move this forward each time), tweak the legends, see `plot.size_spectrum_mlebin()`
