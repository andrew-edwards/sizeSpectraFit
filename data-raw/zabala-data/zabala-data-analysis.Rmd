...
Now repeat the above for small and large separately, if those results
...
ceph_big_min <- dplyr::filter(data_cephall_baseline,
                              species == "Illex coindetii",
                              bin_min > 20,
                              bin_min < 21)$bin_min  # to get the exact value

dplyr::filter(data_cephall_baseline,
              species == "Illex coindetii",
              bin_min == ceph_big_min)
...
cephsmall_xmin
cephsmall_xmax <- floor(ceph_big_min*100)/100   # rounding down to 0.01
cephsmall_xmax
```
