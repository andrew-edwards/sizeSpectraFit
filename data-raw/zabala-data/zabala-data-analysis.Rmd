...
# They include histograms that we don't need.
...
Now to combine the data, do for each strata in turn.
...
This file is very big and takes a while to run (also .pdf keeps hanging).



TODO Need to summarise those results in a plot of $b$ with confidence
intervals. Do in next .Rmd.
