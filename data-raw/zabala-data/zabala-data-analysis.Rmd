...
data_crust_ntr <- mediterranean_for_mlebins(dat_joined,
                                            group_name = "Crustacea",
                                            strata_name = "MPA")   # TODO change
                                              # in data wrangling, also do ntr,
                                              # fg, and baseline. Then simpler
...
TODO HERE next make a table of the results. See summary-table function, though
best to make a tibble.
...
Looks like both steepened, but ntr not as much (though barely). Need to think
about common xmin though. TODO do that next, once have results summarised. And
confirm that xmin are communal, looks like they are.
...
```{r, tablecrustfgold, results = "asis"}
