...
# length.
dat <- dplyr::summarise(group_by(mediterranean_data[1:100, ],
...
# TODO also assuming length values are minimum, wait to hear from Juliana.
# TODO generalise function to include the different options
dat <- cbind(dat,
...
dat_joined[1, c("length", "number", "biomass_bin_min")]
