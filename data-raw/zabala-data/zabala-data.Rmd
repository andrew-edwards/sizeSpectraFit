...
#  So expect results to be slightly different until do that.
...
fung_dat <- cbind(fung_use_simplify,
  ...
  dplyr::filter(!is.na(alpha),  # remove species with no length-weight coefficients
                bin_count != 0,
                biomass_bin_min >= 4)    # 4g and above.

fung_dat[1:10, ] %>% a()

sum(fung_dat$bin_count)   # This should equal n = 7199.6 I think, from MEPS
# Figure 7.
HERE - figure this out NEXT TODO
...
maybe convert to cm straight away.
