...
We are going to save the data as one big tibble, plus the lenght-weight
coefficients.
...
# Rename there to give standard general names for analyses, though likely will
...
# TODO need to document what these mean in the help for the data object.
