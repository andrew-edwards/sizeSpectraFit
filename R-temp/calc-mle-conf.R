...
##'
##' @param negll_fn negative log-likelihood function that take arguments
...
calc_mle_conf <- function(negll_fn,
                          p,
                          vec_diff=0.5,
                          vec_inc=0.001,
  ...
  if(suppress_warnings){
    min_ll = suppressWarnings(nlm(f = negll_fn,
                                  p=p,
                                  ...))
  } else {
    min_ll = nlm(f = negll_fn,
                 p = p,
                 ...)
  }
