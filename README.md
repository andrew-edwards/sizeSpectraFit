...
For a vector of numerical numbers, `x`, representing body sizes
(e.g. body masses of fish), you can simply use the new
`fit_size_spectrum()` function. To demonstrate, we will set `x` to be
the simulated values used in \[1\] (which is saved in the package as
`sim_vec`):
...
<img src="man/figures/README-vecfit-1.png" width="60%" />
